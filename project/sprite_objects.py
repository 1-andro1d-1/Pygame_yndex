    ...
    def __init__(self):
        self.sprite_parameters = {
            ...
            'npc_devil': {
                ...
                'blocked': True,
                'flag': 'npc',
                'obj_action': deque([pygame.image.load(f'sprites/devil/anim/{i}.png')
        ...
        self.list_of_objects = [
            SpriteObject(self.sprite_parameters['sprite_barrel'], (8.1, 2.1)),
            SpriteObject(self.sprite_parameters['sprite_barrel'], (6.9, 2.1)),
            SpriteObject(self.sprite_parameters['npc_devil'], (8.7, 2.5)),
            ...
            SpriteObject(self.sprite_parameters['npc_devil'], (1.26, 8.39)),
            SpriteObject(self.sprite_parameters['npc_devil'], (7.78, 1.47)),
            SpriteObject(self.sprite_parameters['npc_devil'], (8.95, 3.65)),
        ]
...
class SpriteObject:
    ...
    def dead_animation(self):
        self.dead_sprite = pygame.image.load('sprites/deth.png')
